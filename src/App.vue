...
<main id="app">
    ...
    <section class="wrapper ai-window">
        ...
        <div v-if="answers.length == 0 && online == true" class="off-class">
        ...
        <div v-if="answers.length == 0 && online == false" class="off-class">
            <h1 class="title mdc-typography--headline">
            ...
            <tr>
                <td> -->
                    ...
                    <tr v-if="r.type != 0"><td>
                        ...
                        <div v-if="r.type == 'simple_response'" class="bubble bot">
                            {{r.textToSpeech}}
                        </div>
        ...
        <div id="bottom" style="height:70px" v-if="answers.length > 0"></div>
    </section>
    ...
    <div class="query">
        <div class="wrapper" v-if="micro == false">
            ...
            <img src="src/img/send-button(24).png" @click="submit()" class="send-button">
